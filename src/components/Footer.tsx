    ...
    <footer ref={footerRef} className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <section>
            <div className="flex items-center mb-4">
              ...
              <span className="font-bold text-xl text-white">NameCard</span>
            </div>

            <p className="text-gray-400 mb-4">
              Revolutionizing professional networking with digital and AR business cards.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 text-center text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} NameCard. All rights reserved.</p>
          <p className="mt-2">Created by Hunter Ho</p>
        </div>
      </div>
    </footer>
  );
